    ...
    <main className="flex flex-col items-center justify-center px-8 pt-4 pb-8"> {/**/}
      ...
      <div className="relative flex items-center justify-center gap-[48px] mt-[12px]"> {/**/}
        {[skin1, skin2].map((skin, idx) => ( //
          ...
          >
            ...
            />
            <button className="flex flex-col items-center border-4 border-purple-600 rounded-xl hover:border-gold hover:scale-105 transition duration-200 p-2 shadow-lg min-h-[635px]"> {/* MODIFIED: Added min-h-[635px] */}
              {skin.image ? ( //
                <Image
                  src={skin.image} //
                  alt={skin.name} //
                  ...
                  priority={idx < 2} // Consider adding priority for above-the-fold images
                />
              ) : ( //
      ...
      <section className="max-w-4xl text-center"> {/**/}
        ...
        <p className="text-lightPurple mb-[24px]"> {/**/}
          LoL Skin Clash is the ultimate community voting platform where League of Legends players
          decide which skins reign supreme. {/**/}
          Vote between two skins, track rankings, and see which champions {/**/}
          rise to the top based on player votes worldwide. {/**/}
        </p>
      </section>
      ...
      <p className="text-lightPurple mt-[48px] text-center max-w-2xl mb-[64px]"> {/**/}
        Ready to help your favorite skin climb the ranks? {/**/}
        Start voting now and make your voice heard in {/**/}
        the ultimate LoL skin showdown! {/**/}
      </p>
    </main>
  );
}